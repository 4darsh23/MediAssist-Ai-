...
export const InfiniteGridBackground = ({ children, className }) => {
...
export const Component = () => {
  ...
  return (
    <InfiniteGridBackground className="h-screen flex flex-col items-center justify-center bg-background">
